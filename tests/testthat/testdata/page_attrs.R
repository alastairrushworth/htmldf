...
url_list <- list(
  ...
  'ethereum' = list(
    ...
    social = c(
      ...
      'https://youtube.com/channel/UCNOfzGXD_C9YMYmnefmPH0g'
    ), 
    code = NA,
    lang = "en",
  ...
  'reddit'       = list(url    = 'https://www.reddit.com/r/rstats/',
                        rss    = NA,
                        social = c("https://twitter.com/reddit",
                                   "https://reddit.com/r/rstats", 
                                   "https://reddit.com/user/oooodelally"),
  ...
  'towardsds2'   = list(url    = 'https://towardsdatascience.com/multinomial-mixture-model-for-supermarket-shoppers-segmentation-a-complete-tutorial-268974d905da',
                        ...
                        social = c("https://github.com/biarne-a",    
                                   ...
                                   "https://medium.com/", 
                                   "https://medium.com/towards-data-science", 
                                   "https://jamescalam.medium.com", 
                                   "https://skdasaradh.medium.com"),
